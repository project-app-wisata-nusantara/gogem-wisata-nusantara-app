                          ...
                          ClipRRect(
                            ...
                            child: Consumer<MapProvider>(
                              builder: (context, mapProvider, _) {
                                // load destinasi saat pertama kali
                                if (mapProvider.markers.isEmpty) {
                                  return const Center(
                                ...
                                return Stack(
                                  children: [
                                    GoogleMap(
                                      ...
                                      markers: {
                                        Marker(
                                          markerId: MarkerId(widget.destination.nama),
                                          position: currentLatLng,
                                          infoWindow: InfoWindow(
                                            title: widget.destination.nama,
                                            snippet: widget.destination.kabupatenKota,
                                            onTap: () async {
                                              final url =
                  ...
                  const SizedBox(height: 16),
                      ...
                      Consumer<RecommenderProvider>(
                        builder: (context, recommenderProvider, _) {
                          final similar = recommenderProvider.getSimilarRecommendations(widget.destination);
                                      ...
                                      children: [
                                        ClipRRect(
                                          ...
                                          child: dest.linkGambar.startsWith('http')
                                              ? Image.network(dest.linkGambar, height: 120, width: 160, fit: BoxFit.cover)
                                              : Image.asset(dest.linkGambar, height: 120, width: 160, fit: BoxFit.cover),
                                        ),
                                        Padding(
                                          padding: const EdgeInsets.all(8.0),
                                          child: Column(
